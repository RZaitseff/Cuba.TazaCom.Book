...
public class TazacomTestContainer extends TestContainer {

    public TazacomTestContainer() {
        super();
    ...
    public static class Common extends TazacomTestContainer {

        public static final TazacomTestContainer.Common INSTANCE = new TazacomTestContainer.Common();
